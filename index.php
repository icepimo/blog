  ...
  <header class="border-bottom lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="p-2" >
          ...
          <a class="btn btn-sm btn-outline-secondary" href="login.php">login up</a>
      </div>
      </div>
    </div>
  </header>
      ...
      <div class="col-md-7">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2 text-primary-emphasis"><?= $post[0] ?></strong>
            <h3 class="mb-0"><?= $post[1] ?></h3>
            <div class="mb-1 text-body-secondary"><?= $post[4] ?></div>
          ...
          <div class="col-auto d-none d-lg-block">
            <img src=" <?= $post[3] ?> "  width="320" height="400" alt="" srcset="">
